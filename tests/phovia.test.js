...
(async () => {
  ...
  const hookEnv = { PHOVIA_TOKEN_FILE: tokenFile, PHOVIA_SESSION_DIR: sessionDir, PHOVIA_DISABLE_VERSION_CHECK: '1' };
  ...
  try {
    ...
    const lateEnv = { PHOVIA_TOKEN_FILE: lateTokenFile, PHOVIA_SESSION_DIR: lateSessionDir, PHOVIA_DISABLE_VERSION_CHECK: '1' };
